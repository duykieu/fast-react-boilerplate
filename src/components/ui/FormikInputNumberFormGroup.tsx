...
const FormikInputNumberFormGroup: React.FunctionComponent<IFormikInputNumberFormGroupProps> = ({
    fm,
    name,
    label,
    required,
...
export default React.memo(FormikInputNumberFormGroup, (prevProps, nextProps) => {
